      ...
      <el-row class="login-container">
        <div class="container_left">
          <div class="car_bg_box">
            <img class="no-select car_bg" src="../assets/image/topEarth.png" alt>
          </div>
          
        </div>
        <div style="width:2px;height:174px;background:#6ad3d6;float:left;margin-top:123px;"></div>
...
.hello ::v-deep {
  width: 100%;
  height: 100%;
  background-image: url("../assets/image/loginbgb2.png");
  ...
  .login_bg {
    ...
    .login-container {
      ...
      box-shadow: 0px 0px 47px 2px #BFDFDF;
      .container_left {
        width: 400px;
        float: left;
        position: relative;
